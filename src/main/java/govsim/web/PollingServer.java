...
public class PollingServer {
  ...
  private void handleChat(HttpExchange exchange) throws IOException {
    ...
    if ("POST".equalsIgnoreCase(exchange.getRequestMethod())) {
      ...
      chatStore.addMessage(name == null ? "" : name.toString(), message == null ? "" : message.toString());
      exchange.sendResponseHeaders(204, -1);
      return;
    }
...
<body>
    ...
    <section class="card">
      ...
      <div style="margin-top:16px;">
        ...
        <div class="row" style="margin-top:8px;">
          <input id="chatName" placeholder="Name" style="flex:1; min-width:120px; padding:8px; border-radius:6px; border:1px solid #2a3645; background:#0b0f14; color:#e6edf3;" />
  ...
  <script>
    ...
    async function vote(choice) {
      await fetch(`/vote?choice=${choice}`, { method: 'POST', cache: 'no-store' });
      fetchStatus();
    }
